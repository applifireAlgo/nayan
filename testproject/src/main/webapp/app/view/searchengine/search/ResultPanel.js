Ext
		.define(
				'Testproject.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testproject.view.searchengine.search.SearchEngineMainPanelController','Testproject.view.searchengine.search.PanelHeaderField' ,'Testproject.view.searchengine.search.ReportGridView','Testproject.view.searchengine.search.ReportChartView','Testproject.view.searchengine.search.documentView','Testproject.view.searchengine.search.DouMeanView','Testproject.view.googlemaps.map.MapPanel'],
