Ext.define('Testproject.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Testproject.view.searchengine.search.NorthPanel', 'Testproject.view.searchengine.search.SearchResult','Testproject.view.searchengine.search.SearchEngineMainPanelController'],
