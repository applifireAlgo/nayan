Ext.define('Testproject.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Testproject.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Testproject.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Testproject.view.querybuildernewmodel.floatingentity.EntitySprite',
