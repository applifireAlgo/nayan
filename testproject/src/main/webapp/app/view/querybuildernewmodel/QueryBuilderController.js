Ext.define('Testproject.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Testproject.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Testproject.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Testproject.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Testproject.view.querybuildernewmodel.querydetail.QueryDetail');
