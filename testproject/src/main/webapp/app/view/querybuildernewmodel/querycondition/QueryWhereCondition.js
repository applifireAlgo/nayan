Ext.define('Testproject.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Testproject.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
