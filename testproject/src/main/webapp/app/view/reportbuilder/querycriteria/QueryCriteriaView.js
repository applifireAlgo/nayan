Ext.define('Testproject.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Testproject.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Testproject.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Testproject.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Testproject.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
