Ext.define('Testproject.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Testproject.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Testproject.view.reportbuilder.gridconfig.GridConfigView',
	           'Testproject.view.reportbuilder.properties.PropertiesPanelView',
	           'Testproject.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
