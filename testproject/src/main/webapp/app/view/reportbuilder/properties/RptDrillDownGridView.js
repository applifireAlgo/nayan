Ext.define('Testproject.view.reportbuilder.properties.RptDrillDownGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Testproject.view.reportbuilder.properties.RptDrillDownGridController'],
