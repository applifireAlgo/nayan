Ext.define('Testproject.view.reportbuilder.properties.RptChartPropGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Testproject.view.reportbuilder.properties.RptChartPropGridController'],
