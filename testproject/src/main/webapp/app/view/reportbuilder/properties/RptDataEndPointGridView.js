Ext.define('Testproject.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Testproject.view.reportbuilder.properties.RptDataEndPointGridController'],
