Ext.define('Testproject.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Testproject.view.reportbuilder.reportlist.ReportListPanelView',
             'Testproject.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Testproject.view.reportbuilder.mainview.ReportMainController'
             ],
