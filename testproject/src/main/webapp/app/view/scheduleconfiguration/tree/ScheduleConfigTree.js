 ...
 * 
 */
Ext.define("Testproject.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Testproject.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
