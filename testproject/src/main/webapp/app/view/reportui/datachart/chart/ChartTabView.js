Ext.define('Testproject.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Testproject.view.reportui.datachart.chart.RatingField','Testproject.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
