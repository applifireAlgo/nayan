Ext.define('Testproject.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Testproject.view.usermanagement.admin.UserPasswordReset',
	            'Testproject.view.usermanagement.admin.AddUserDetails',
	            'Testproject.view.usermanagement.admin.ViewUser'],
