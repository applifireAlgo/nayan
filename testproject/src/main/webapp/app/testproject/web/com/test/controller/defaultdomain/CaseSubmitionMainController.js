Ext.define('Testproject.testproject.web.com.test.controller.defaultdomain.CaseSubmitionMainController', {
     extend: 'Testproject.view.fw.frameworkController.AggregateViewController',
     alias: 'controller.CaseSubmitionMainController',
     init: function() {
     ...
     renderTreeGridData: function(responseData) {
          ...
          if (responseData.response.success) {
               ...
               var tree = this.view.down('#CaseSubmitionTree');
               ...
               var compRef = this.view.down('#CaseSubmitionTree');
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.caseId;
          me = this;
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#CaseSubmition');
          var grid = this.view.down('#CaseSubmitionGrid');
          var tree = this.view.down('#CaseSubmitionTreeContainer');
     ...
     onFilterClick: function(but, evt) {
          ...
          Ext.Ajax.request({
               ...
               failure: function(response, currentObject) {
                    ...
                    var compRef = scope.sender.view.down('#CaseSubmitionTree');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               var CaseSubmition = this.view.down('#CaseSubmitionForm');
               CaseSubmition.reset();
               var gridPanel = this.view.down('#CaseSubmitionGrid');
          ...
          var formPanel = this.getView().up().down('#CaseSubmitionForm');
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) { /** Finding record by id */
          ...
          var treePanel = this.view.up().up().down('#CaseSubmitionTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#CaseSubmition').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#CaseSubmitionGrid').store;
          gridStore.removeAll();
          gridStore.add(data);
     ...
     loadData: function(responseData) {
          this.view.down('#CaseSubmitionForm').getViewModel().setData(responseData.response.data);
     },
