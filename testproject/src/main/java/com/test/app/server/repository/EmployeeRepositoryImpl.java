...
public class EmployeeRepositoryImpl extends SearchInterfaceImpl implements EmployeeRepository<Employee> {
    ...
    @Override
    @Transactional
    public List<Employee> findAll() throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<com.test.app.shared.defaultdomain.Employee> query = emanager.createQuery("select u from Employee u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    @Override
    @Transactional
    public Employee save(Employee entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<Employee> save(List<Employee> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.test.app.shared.defaultdomain.Employee obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.test.app.shared.defaultdomain.Employee s = emanager.find(com.test.app.shared.defaultdomain.Employee.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Override
    @Transactional
    public void update(Employee entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<Employee> entity) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.test.app.shared.defaultdomain.Employee obj = entity.get(i);
    ...
    @Transactional
    public List<Employee> findByContactId(String contactId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("Employee.findByContactId");
            query.setParameter("contactId", contactId);
            java.util.List<com.test.app.shared.defaultdomain.Employee> listOfEmployee = query.getResultList();
    ...
    @Transactional
    public List<Employee> findByDept(String dept) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("Employee.findByDept");
    ...
    @Transactional
    public Employee findById(String empId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("Employee.findById");
            query.setParameter("empId", empId);
            com.test.app.shared.defaultdomain.Employee listOfEmployee = (com.test.app.shared.defaultdomain.Employee) query.getSingleResult();
            return listOfEmployee;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
