...
public class MaterialTestCase {
    ...
    public void test1Save() {
        try {
            ...
            brand.setBranddesc("Ho711VbrgWU9OxVz8w2w7Syrq8tuxg8DHwHA2WX9UUABAudS7q");
            Category category = new Category();
            category.setCategory("SUllP5P5uOYVFe1ITcAzy2i224VNdOuSGdmdXGLI8vP5fExRuh");
            Category CategoryTest = categoryRepository.save(category);
            map.put("CategoryPrimaryKey", category._getPrimarykey());
            brand.setBranddesc("MFjqXLTMFNrlt8yxvSkDpkebJbISbHUZ4VOwFryt0vLzCzYaQL");
            ...
            material.setMaterialdesc("aPnRmRvy5b4lgdemyhcdqwMUQaQMgS5lJeoD6tgEkDUw0QdyW6");
    ...
    public void test2Update() {
        try {
            ...
            material.setMaterialdesc("l11rrDuXZzZ9v8b8ql5dhfpOiWLPDCC6x67f2kt6dnkk5uzCFr");
