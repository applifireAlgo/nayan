...
public class AppCustomerTypeTestCase {
    ...
    public void test1Save() {
        try {
            ...
            appcustomertype.setCustomerType("F0tnwzNvQ2OCWi0PewL7gSRaZmgisXYwjv9lNgOX3OpJFO4f7X");
    ...
    public void test2Update() {
        try {
            ...
            appcustomertype.setCustomerType("2gDN7ubTPly8beEcBITSicthQpnAp2e3TbhNYEazBLwq2RQnfr");
            appcustomertype.setDefaults(1);
            appcustomertype.setSequenceId(2147483647);
