...
public class BrandTestCase {
    ...
    public void test1Save() {
        try {
            ...
            category.setCategory("iuoUfgu7gxpRdQDJvYjgyO04VvLAtPjtajYyGSVxDI9TzMUGsN");
            Category CategoryTest = categoryRepository.save(category);
            map.put("CategoryPrimaryKey", category._getPrimarykey());
            Brand brand = new Brand();
            brand.setBranddesc("RNQjFObSL10VQ6C5SETZk4K0ssIoeqgRtMu8ODO5Wn0ksuNmR6");
    ...
    public void test2Update() {
        try {
            ...
            brand.setBranddesc("MuUwq7BHRHvwQCpJC59OwTcSn0BccKDBLm0l6QrUKUgU1l7yyh");
