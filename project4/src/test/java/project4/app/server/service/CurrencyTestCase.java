...
import project4.app.server.repository.CurrencyRepository;
import project4.app.shared.location.Currency;
...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("yfpqcOWBbpDbmF5o1QEstG1dVsOQU5fg");
            country.setCapitalLatitude(0);
            country.setCapitalLongitude(10);
            country.setCountryCode1("cuP");
            country.setCountryCode2("Dui");
            country.setCountryFlag("oW4rPRcwatvAUvw2MaRfFlvr5OSKoHO73wsIpQKhzx2YwAJqD3");
            country.setCountryName("KGvSiKopus9Odgejn7cjgC5PQXHwKWPYBxSaGfFG3I8qm01XIP");
            country.setCurrencyCode("cjg");
            country.setCurrencyName("opddwq8bul0USQnzaJEXqy2FhdCtCUpKA11R6jVrmldNEgoMGG");
            country.setCurrencySymbol("hUBVaVABTWAG8vorBoTtIDLMsPtfYrWJ");
            country.setIsoNumeric(1);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("9ibs14CQ6j9gzoNWBq9QbwT0Q6k16MKAhFGDaEtThkTmcecuRa");
            currency.setUnicodeDecimal("SADt02ijV9DPzMGv5HSNWF37d5YYlRSrl2uTfwOBECXmkHUHcs");
            currency.setUnicodeHex("8FajMk89oWDn8E3wQ301zu8YZDX8ujL4M8pQh5s5bPH0vSXP7i");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("zJtswy9Mpn3j5X7NMLIu5o4vDBbiVjhAYTgp5elbBFResbsHyN");
            currency.setUnicodeDecimal("VHLcrjKq2stq5Owv0Q2yXYs2bByAY7SDGqCaxyZbRXFmLXoSXn");
            currency.setUnicodeHex("60j6cN1cAWGhwd2a93tMzvOVBjcnNZUYwq0DsNOzJ9exQ8ltyx");
