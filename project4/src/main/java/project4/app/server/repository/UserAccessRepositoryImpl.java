...
public class UserAccessRepositoryImpl extends SearchInterfaceImpl implements UserAccessRepository<UserAccess> {
    ...
    public List<UserAccess> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<project4.app.shared.sales.UserAccess> query = emanager.createQuery("select u from UserAccess u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<UserAccess> save(List<UserAccess> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                project4.app.shared.sales.UserAccess obj = entity.get(i);
    ...
    public void delete(Integer id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            project4.app.shared.sales.UserAccess s = emanager.find(project4.app.shared.sales.UserAccess.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<UserAccess> findByUserId(String userId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<project4.app.shared.sales.UserAccess> listOfUserAccess = query.getResultList();
    ...
    public UserAccess findById(Integer userAccessId) throws Exception, SpartanPersistenceException {
        try {
            ...
            project4.app.shared.sales.UserAccess listOfUserAccess = (project4.app.shared.sales.UserAccess) query.getSingleResult();
            return listOfUserAccess;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
